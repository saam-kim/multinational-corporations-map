  ...
  return <main className="teacher-shell">
    ...
    <section className="teacher-layout">
      ...
      <section className="dashboard-main">
        ...
        <details className="lesson-guide teacher-lesson"><summary>99쪽 연계 수업 안내 · 관찰 기준</summary><p>교과서로 기능별 입지 원리를 설명한 뒤, 베트남·인도 노이다의 생산 기능을 비교하고 미국 텍사스를 반례로 살펴보세요. 연구개발의 확장 사례는 인도 벵갈루루입니다.</p><p>관찰 기준: ① 지역 단서를 골랐는가 ② 기업 활동의 이점과 연결했는가 ③ 두 지역을 비교하고 처음 설명을 보완했는가. 제출·열람은 이해도 점수가 아닙니다.</p><p>예시 50분: 교과서 10분 → 두 거점 탐구 15분 → 비교 10분 → 선진국 생산 사례 토론 10분 → 한 문장 정리 5분. 지역의 고용·환경 변화는 100쪽 이후 수업으로 확장할 수 있습니다.</p></details>
